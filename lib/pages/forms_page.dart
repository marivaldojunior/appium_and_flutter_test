...
class _FormsPageState extends State<FormsPage> {
  ...
  Future<void> _selectDate(BuildContext context) async {
    final DateTime? picked = await showDatePicker(
      ...
      ), // Permite selecionar até 5 anos no futuro
    );
  ...
  void _submitForm() {
    if (_formKey.currentState!.validate()) {
      ...
      print(
        'Data Selecionada: ${_selectedDate != null ? DateFormat('dd/MM/yyyy').format(_selectedDate!) : 'Não selecionada'}',
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Formulários Diversos')),
      body: SafeArea(
        child: Padding(
          ...
          child: Form(
            key: _formKey,
            child: ListView(
              // Usar ListView para permitir rolagem se o conteúdo for grande
              children: <Widget>[
                ...
                FormField<DateTime>(
                  ...
                  validator: (value) {
                    if (_selectedDate == null) {
                      // Usamos a variável de estado aqui
                ...
                DropdownButtonFormField<String>(
                  ...
                  validator: (value) =>
                      value == null ? 'Por favor, selecione um país.' : null,
                ),
                const SizedBox(height: 16.0),
