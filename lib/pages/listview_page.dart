...
class _ListViewPageState extends State<ListViewPage> {
  ...
  void initState() {
    ...
    _items.addAll([
      ListItemData(id: _generateId(), title: 'Item 1', description: 'Descrição detalhada do Item 1'),
      ListItemData(id: _generateId(), title: 'Item 2', description: 'Explicação sobre o Item 2'),
      ListItemData(id: _generateId(), title: 'Item 3', description: 'Mais informações do Item 3'),
      ListItemData(id: _generateId(), title: 'Item 4', description: 'Detalhes extras para o Item 4'),
    ]);
  }
  ...
  void _showAddItemDialog() {
    ...
    final _formKey = GlobalKey<FormState>(); // Chave para validar o formulário do popup
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Form( // Adiciona um Form para validação
              key: _formKey,
              child: Column(
              ...
              onPressed: () {
                ...
                if (_formKey.currentState!.validate()) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Novo item adicionado!'), duration: Duration(seconds: 1)),
                  );
                }
              },
            ),
  ...
  void _editItem(ListItemData itemToEdit) {
    ...
    final formKey = GlobalKey<FormState>(); // Chave para validar o formulário do popup
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                if (formKey.currentState!.validate()) {
                  setState(() {
                    final index = _items.indexWhere((item) => item.id == itemToEdit.id);
                    if (index != -1) {
                  ...
                  Navigator.of(context).pop();
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Item atualizado!'), duration: Duration(seconds: 1)),
                  );
                }
              },
            ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Lista com Swipe'),
      ),
      body: _items.isEmpty
          ? const Center(
        child: Text(
        ...
        itemBuilder: (context, index) {
          ...
          return Dismissible(
            ...
            confirmDismiss: (DismissDirection direction) async {
              if (direction == DismissDirection.startToEnd) { // Direita (Excluir)
                ...
                return await showDialog(
                  ...
                  builder: (BuildContext context) {
                    return AlertDialog(
                      ...
                      content: Text("Você tem certeza que deseja excluir '${item.title}'?"),
                      actions: <Widget>[
                        TextButton(
              ...
              } else if (direction == DismissDirection.endToStart) { // Esquerda (Editar)
                _editItem(item);
            ...
            child: Card(
              ...
              child: ListTile(
                ...
                onTap: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text('Item selecionado: ${item.title}')),
                  );
                },
              ),
            ),
